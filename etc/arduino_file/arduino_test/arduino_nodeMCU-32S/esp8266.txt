...
// SoftwareSerial NAME(TX, RX);
String sendData(String command, const int timeout, boolean debug);
//const char wifi_name[] ="122b";
//const char wifi_pw[] ="122b122b";
int server_connect = 0;
//define 0 = disconnet
//
//[2]dht******************//
DHT dht(DHTPIN, DHTTYPE);
// DHT설정 - dht (디지털2, dht11)
int Humidity;
//습도 데이터
int Temperature;
//온도 데이터
void set_home_data() {
  ...
  // 변수  Humidity에 습도 값을 저장
  Temperature = dht.readTemperature();
  // 변수 Temperature에 온도 값을 저장
}
...
void setting_server() {
  ...
  //와이파이 연결유무 확인하는건데 이부분 수정 부탁
  if (sendData("AT+CWJAP?", 1000, DEBUG) != ""){
    server_connect = 1;
  } else {
    server_connect = 0;
  }
